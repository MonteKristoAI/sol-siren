...
const ImageGallery = ({ images, name }: { images: string[]; name: string }) => {
  ...
  return (
    <div>
      {/* Main image */}
      <div className="group relative <div className="group relative aspect-[4/5] overflow-hidden border border-border bg-muted"> overflow-hidden border border-border bg-muted">
