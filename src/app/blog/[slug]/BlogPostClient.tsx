  ...
  return (
    <main className="bg-background pt-24 md:pt-32">
      <article className="mx-auto max-w-3xl px-6 md:px-8 pb-24 md:pb-32">
        ...
        {post.htmlBody ? (
          <div
            className="mt-10 font-body text-sm md:text-base text-foreground/80 leading-relaxed [&_h2]:font-display [&_h2]:text-2xl [&_h2]:md:text-3xl [&_h2]:font-light [&_h2]:text-foreground [&_h2]:mt-12 [&_h2]:mb-4 [&_h3]:font-display [&_h3]:text-xl [&_h3]:text-foreground [&_h3]:mt-8 [&_h3]:mb-3 [&_p]:mb-5 [&_ul]:mb-6 [&_ul]:pl-5 [&_ul]:list-disc [&_li]:mb-2 [&_img]:my-8 [&_img]:w-full [&_img]:h-auto [&_svg]:my-8 [&_svg]:max-w-full [&_svg]:h-auto [&_figure]:my-8 [&_figcaption]:text-xs [&_figcaption]:opacity-60 [&_table]:w-full [&_table]:my-8 [&_table]:text-sm [&_th]:text-left [&_th]:p-2 [&_td]:p-2 [&_.byline]:text-xs [&_.byline]:tracking-wide [&_.byline]:uppercase [&_.byline]:opacity-60 [&_.byline]:mb-6 [&_aside.mk-takeaways]:border [&_aside.mk-takeaways]:border-border [&_aside.mk-takeaways]:p-6 [&_aside.mk-takeaways]:my-8 [&_aside.mk-cta]:border [&_aside.mk-cta]:border-border [&_aside.mk-cta]:p-8 [&_aside.mk-cta]:mt-12 [&_aside.mk-cta]:text-center [&_a.mk-cta-button]:inline-block [&_a.mk-cta-button]:mt-4 [&_a.mk-cta-button]:border [&_a.mk-cta-button]:border-foreground [&_a.mk-cta-button]:px-6 [&_a.mk-cta-button]:py-3 [&_a.mk-cta-button]:text-xs [&_a.mk-cta-button]:tracking-widest [&_a.mk-cta-button]:uppercase [&_a]:underline [&_a]:underline-offset-2 [&_aside.mk-related]:border [&_aside.mk-related]:border-border [&_aside.mk-related]:p-6 [&_aside.mk-related]:my-8 [&_aside.mk-related_h2]:text-xs [&_aside.mk-related_h2]:uppercase [&_aside.mk-related_h2]:tracking-widest [&_aside.mk-related_h2]:opacity-60 [&_aside.mk-related_h2]:mb-3 [&_aside.mk-related_h2]:font-body [&_aside.mk-related_ul]:list-none [&_aside.mk-related_ul]:pl-0 [&_aside.mk-related_ul]:mb-0 [&_aside.mk-related_li]:mb-2 [&_aside.mk-related_a]:no-underline [&_aside.mk-related_a]:opacity-80 hover:[&_aside.mk-related_a]:opacity-100"
